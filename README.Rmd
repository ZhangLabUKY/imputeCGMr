...
and feature columns, run `run_missing_glucose_imputation()`, preview the rows
that were originally missing and imputed, and download the completed data as a
CSV file.
...
The main vignette contains a detailed walkthrough of data requirements, return
