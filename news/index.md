...
- Added a bundled Shiny app for interactive missing glucose imputation.
  ...
  relevant columns, run imputation, preview results, and download the
  completed data.
...
- Updated README and vignettes to describe timestamp-gap handling, the
  simplified output structure, the bundled Shiny app, backend options,
  and post-imputation rounding.
